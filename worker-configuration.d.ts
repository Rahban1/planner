/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 69de4bcbec71bf256822d7293ec8a22b)
// Runtime types generated with workerd@1.20260701.1 2025-09-02 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	ATTACHMENTS: R2Bucket;
	DB: D1Database;
	CF_ACCESS_TEAM_DOMAIN: "https://lingering-morning-658a.cloudflareaccess.com";
	CF_ACCESS_AUDIENCE: "ca0e50f2e3868fb061ee50e86db5a908e7fc22197b29fd836c4b6ef49c3e40d9";
	GITHUB_ACTIONS_OWNER: "Rahban1";
	GITHUB_ACTIONS_REPOSITORY: "planner";
	GITHUB_ACTIONS_WORKFLOW: "planner-agent-run.yml";
	...
	TASK_CHAT_ROOMS: DurableObjectNamespace<import("./src/worker").TaskChatRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "TaskChatRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUDIENCE" | "GITHUB_ACTIONS_OWNER" | "GITHUB_ACTIONS_REPOSITORY" | "GITHUB_ACTIONS_WORKFLOW" | "GITHUB_ACTIONS_REF" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "RUNNER_API_TOKEN" | "GITHUB_ACTIONS_DISPATCH_TOKEN">> {}
}
