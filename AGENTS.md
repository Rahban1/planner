...
For repeatable UI proof in a fresh environment, run `pnpm proof:ui`. Open `http://127.0.0.1:3000/api/auth/local-proof`, select **Open proof dashboard**, and use the isolated test data. See `docs/UI_PROOF.md`. Do not use the deployed application to prove an unmerged branch.
